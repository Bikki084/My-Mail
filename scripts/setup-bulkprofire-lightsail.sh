#!/usr/bin/env bash
# Single Lightsail instance cutover for bulkprofire.com
#
# Instance: Ubuntu-1 (Mumbai) — public IPv4 13.203.176.51
# Domain DNS (Hostinger acc_B): A @ → 13.203.176.51, CNAME www → bulkprofire.com
#
# Run ON the Lightsail instance (browser SSH or ssh ubuntu@13.203.176.51):
#   cd ~/mymail && git pull && bash scripts/setup-bulkprofire-lightsail.sh
#
...
export BULK_DOMAIN="bulkprofire.com"
...
Hostinger DNS (acc_B) — ONLY these records:
