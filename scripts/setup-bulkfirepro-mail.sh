#!/usr/bin/env bash
# Configure Postfix on this VPS for bulkfirepro.com (local relay on 127.0.0.1:25).
...
request removal with your cloud provider or use SendGrid SMTP on port 587 instead.
============================================================
EOF
